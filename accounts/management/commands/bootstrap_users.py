...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        u, _ = User.objects.get_or_create(username=admin_user, defaults={"email": admin_email})
        u.email = admin_email
        u.is_staff = True
        u.is_superuser = True
        ...
        p, _ = User.objects.get_or_create(username=parent_user, defaults={"email": parent_email})
